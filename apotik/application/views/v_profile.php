...
<body>
		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div style="text-align: center; font-size: 50px; font-family: Comic Sans MS, cursive, sans-serif;color: orange">
				<script language="JavaScript">
    				var text="Welcome to <?php echo $this->session->nama; ?> Apotik Online";
    				var delay=30;
    				var currentChar=1;
	...
	<div class="container">
		<div class="col-md-4" style="background-color: lightgray; width: 400px; height: 300px; padding: 25px;margin: 25px; ">
			<table width="300px">
				<tr>
					<td>Nama</td>
					<td>:</td>
		...
		<div class="col-md-4" style="background-color: lightgray; width: 300px; height: 300px;padding: 25px; margin: 25px; ">
