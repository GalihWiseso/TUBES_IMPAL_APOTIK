					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="<?php echo base_url("single.php") ?>" class="link-product-add-cart">Quick View</a>
										</div>
									</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="<?php echo base_url("single.php") ?>">Actifed Batuk</a>
									</h4>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="<?php echo base_url("single.php") ?>">Neozep Forte</a>
									</h4>
									<div class="info-product-price">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									<h4>
										<a href="<?php echo base_url("single.php") ?>">Panadol</a>
									</h4>
									<div class="info-product-price">
